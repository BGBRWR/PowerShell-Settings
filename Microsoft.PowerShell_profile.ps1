function workon {
    ...
    DynamicParam {
        ...
        $arrSet = Get-ChildItem -Path C:\Users\ArmyB\Repositories\Envs -Directory | Select-Object -ExpandProperty Name
...
$ThemeSettings.MyThemesLocation = 'C:\Users\ArmyB\Documents\WindowsPowerShell\PoshThemes'
