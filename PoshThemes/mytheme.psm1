...
function Write-Theme {
    ...
    $tempColor = $sl.Colors.SessionInfoBackgroundColor
    if ($sl.Colors.SessionInfoBackgroundColor -eq 'Black') {
        $tempColor = 'Black';
    }

    if (Test-VirtualEnv) {
        Write-Prompt -Object "$($sl.PromptSymbols.SegmentForwardSymbol)" -ForegroundColor $tempColor -BackgroundColor $sl.Colors.VirtualEnvBackgroundColor
        ...
        Write-Prompt -Object "$($sl.PromptSymbols.SegmentForwardSymbol) " -ForegroundColor $tempColor -BackgroundColor $sl.Colors.PromptBackgroundColor
    }
    ...
    if ($status) {
        ...
        $themeInfo.BackgroundColor = [ConsoleColor]::Yellow
...
$sl.Colors.SessionInfoForegroundColor = (get-host).ui.rawui.ForegroundColor
